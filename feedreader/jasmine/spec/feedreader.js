...
$(function () {
    ...
    describe('RSS Feeds', function () {
        ...
        /* This test is check if the names are defined */
    ...
    /* test suit about menu behaviour */
    ...
    /* test suit  about the Initial Entities.
     */
    ...
    /* test suit for Selection of a New Feed.
     */
    describe('New Feed Selection', function () {
        ...
        it('loads a new feed', function () {
            expect(newContent).not.toBe(updatedContent);
        });
    });
}());
